...
Entity.prototype.algorithm = function(AI){
    ...
    switch(AI === undefined ? this.alignment : AI){
        ...
        case 2: // will rest lol
            if(this.fatigue > 70){ this.cd = -100; return; }
            this.setSpeed(5);
            break;
...
Entity.prototype.process = function(){
    ...
    this.stamina = min(this.stamina + this.regen, 100 - this.fatigue);
    this.algorithm();
};
Entity.prototype.draw = function() {
    ...
    pushStyle();
    stroke(105, 255, 210);
    line(-15, -20, -15 + (this.stamina/100)*30, -20);
    stroke(122, 122, 122);
    line(-15 + (this.stamina/100)*30, -20, 15 - (this.fatigue/100)*30, -20);
    stroke(255, 140, 140);
    line(15 - (this.fatigue/100)*30, -20, 15, -20);
    stroke(216, 87, 255);
